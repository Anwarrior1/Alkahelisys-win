...
function viewFromHash(): View {
  ...
  if (raw === 'expenses') return 'finance';
...
const EXPENSE_CATEGORIES = ['مواد تنظيف', 'صيانة', 'مرافق', 'وقود', 'إيجار', 'أجور', 'أخرى'];
...
function ReportsView({ userId, selectedDate, isManager }: { userId: string; selectedDate: string; isManager: boolean }) {
  ...
  return (
    <>
      <PageHeader eyebrow={isManager ? 'التحليل المالي والتشغيلي' : 'التقارير التشغيلية'} title="التقارير المالية" description={isManager ? 'الإيرادات والأرباح والمصروفات وديون المعارض والأداء بحسب الفترة المختارة.' : 'تقارير تشغيلية للمركبات والعمال دون أي بيانات مالية.'} />
